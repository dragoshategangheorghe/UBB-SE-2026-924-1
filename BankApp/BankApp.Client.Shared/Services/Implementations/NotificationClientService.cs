...
//you cannot use windows specific things, since we need to migrate to class library
namespace BankApp.Client.Services.Implementations
{
    public sealed class NotificationClientService : INotificationClientService
    {
        ...
        //this is not good, 3 buttons for every setting that does not do anything
