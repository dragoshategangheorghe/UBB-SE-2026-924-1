...
namespace BankApp.Server.Tests
{
    ...
    public class StatisticsServiceTests
    {
        ...
        private IOptions<TeamCOptions> _options;
        ...
        public void SetUp()
        {
            ...
            _options = Options.Create(new TeamCOptions());

            _statisticsService = new StatisticsService(_mockTransactionHistoryRepository, _options);
        }

        [Test]
        public void GetSpendingByCategory_SuccessfulDebitTransactionsPresent_SuccessResponse()
        {
            _mockTransactionHistoryRepository.GetTransactionsByUserId(GetTestId()).Returns(CreateTransactionsForGetSpendingByCategory());

            var result = _statisticsService.GetSpendingByCategory(GetTestId());
        ...
        {
            _mockTransactionHistoryRepository.GetTransactionsByUserId(GetTestId()).Returns(CreateTransactionsWithEmptyCategoryAndZeroAmount());

            SpendingByCategoryResponse result = _statisticsService.GetSpendingByCategory(GetTestId());
        ...
        {
            _mockTransactionHistoryRepository.GetTransactionsByUserId(GetTestId()).Returns(CreateCreditAndDebitTransactions());

            IncomeVsExpensesResponse result = _statisticsService.GetIncomeVsExpenses(GetTestId());
        ...
        public void GetBalanceTrends_SuccessfulTransactionsPresentAcrossMultipleDays_SelectsLatestBalanceEveryDay()
        {
            ...
            _mockTransactionHistoryRepository.GetTransactionsByUserId(GetTestId()).Returns(new List<TransactionHistoryItemDto>
            {
            ...
            BalanceTrendsResponse result = _statisticsService.GetBalanceTrends(GetTestId());
        ...
        {
            _mockTransactionHistoryRepository.GetTransactionsByUserId(GetTestId()).Returns(CreateTransactionsForGetTopRecipients());

            TopRecipientsResponse result = _statisticsService.GetTopRecipients(GetTestId());
        ...
        {
            _mockTransactionHistoryRepository.GetTransactionsByUserId(GetTestId()).Returns(CreateTransactionsForOnlyOneRecipient());
